...
export default function Home() {
  ...
  useEffect(() => {
    setHasMounted(true);
    let start = 0;
    const duration = 1200; // ~4.6 seconds duration
        ...
        {loading ? (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute w-[500px] sm:w-[600px] aspect-square rounded-full bg-[#0ea5e9]/10 blur-[80px] pointer-events-none -translate-y-10 animate-pulse duration-[6s] z-0"
            />
            <div className="absolute w-[400px] sm:w-[500px] aspect-square rounded-full bg-[#38bdf8]/5 blur-[70px] pointer-events-none translate-x-[20%] translate-y-[15%] z-0" />
            ...
            <div className="relative max-w-lg w-full px-6 flex flex-col items-center justify-center text-center z-20">
