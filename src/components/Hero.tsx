...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-[5%] w-[380px] sm:w-[600px] h-[380px] sm:h-[600px] rounded-full bg-sky-600/10 blur-[70px] sm:blur-[90px] pointer-events-none -z-10" />
      <div className="absolute bottom-1/4 left-[8%] w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] rounded-full bg-sky-700/5 blur-[70px] sm:blur-[90px] pointer-events-none -z-10" />
